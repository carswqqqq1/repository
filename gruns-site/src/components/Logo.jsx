...
/** Grüns wordmark. Inherits colour from the parent via `currentColor`. */
export default function Logo({ width = 96, className = '', title = 'Grüns' }) {
  return (
    <svg
      className={className}
      width={width}
